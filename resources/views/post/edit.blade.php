            ...
            <div class="container px-6 py-1 pb-16 mx-auto">
              <div class="p-5 my-6 bg-white rounded shadow-md">
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <textarea name="description" id="description" placeholder="Enter description" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-200" rows="5">{{ old('description',$post->description) }}</textarea>
                </div>
